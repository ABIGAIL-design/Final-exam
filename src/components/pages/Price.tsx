        ...
        <div className="flex flex-col justify-center space-y-4">
          <div>
            <div className="space-y-2 mb-20">
              <h1 className="text-3xl text-[#3B71CA] text-center mt-8 font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                Our prices
              </h1>
              <p className="max-w-[600px] text-[#9b9a9a] text-center pt-1 m-auto text-muted-foreground md:text-xl">
                Find the perfect plan for your shortener.
              </p>
            </div>
