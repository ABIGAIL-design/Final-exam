      ...
      <div className="flex flex-col mt-[150px] mx-2 min-h-screen overflow-hidden bg-muted/40">
        <main className="flex-1  justify-center overflow-hidden">
          <div className="m-auto ">
            <div className="mb-8">
              <h1 className="md:text-3xl text-2xl font-bold text-[#3B71CA]">
                Analytics
              </h1>
              <p className="text-muted-foreground text-[#9b9a9a]">
                Track the performance of your shortner.
              </p>
            </div>
            <div className="">
              <main className="border-2 mb-5 px-2 py-5 rounded-md">
                ...
                <h1>
                  <div className="flex text-[] items-center mt-4 justify-center text-5xl font-bold">
                    {data.length}
                  </div>
                </h1>
              </main>
              ...
              <section className="border-2 pl-2 pr-2 py-5 lg:w-[80%] m-auto md:w-[100%]">
                <div className="space-y-1 mb-5">
                  <h2 className="md:text-3xl text-2xl text-[#3B71CA] font-bold">
                    Shortened URLs
                  </h2>
